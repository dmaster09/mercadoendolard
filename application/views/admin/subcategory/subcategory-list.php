    ...
    <div class="card card-default">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"> <i class="fa fa-list"></i> &nbsp; <b><?= get_category_name($this->uri->segment(3)) ?></b>'s Subcategories</h3>
        </div>
        <div class="d-inline-block pull-right">
          <a href="<?= base_url('admin/category/'.$this->uri->segment(3).'/subcategories/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New Subcategory</a>
        </div>
      </div>

	...
	<div class="container">
		...
		<div class="row d-flex align-items-center justify-content-center">
			...
			<div class="about-content col-lg-12">
				...
				<p class="text-white link-nav"><a href="<?= base_url() ?>">Home </a>  <span class="lnr lnr-arrow-right"></span> <a href="<?= base_url('blog') ?>"> Blog</a> <span class="lnr lnr-arrow-right"></span> <a href="<?= base_url('blog/post/'.$post['slug']) ?>"> <?= $title ?></a></p>
